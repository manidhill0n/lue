#' @title Light Use Efficiency Model to Estimate Crop Yield Using Vapour Pressure Deficit
#' @usage LUE_YIELD_VPD(fpar_raster,par,tmin,tmax,tdew,tmin_min,tmin_max,vpd_max, vpd_min,LUE_optimal)
